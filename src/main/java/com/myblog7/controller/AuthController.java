...
public class AuthController {
    ...
    public ResponseEntity<JWTAuthResponse> authenticateUser(@RequestBody LoginDto loginDto){
        //JWTAuthResponse this is the one that will send back the response JwtTonken to postman
    ...
    @PostMapping("/signup")
    public ResponseEntity<?> registerUser(@RequestBody SignUpDto signUpDto){//from the dto copy the data from into user obj
